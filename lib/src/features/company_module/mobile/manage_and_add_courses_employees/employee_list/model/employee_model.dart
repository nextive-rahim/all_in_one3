...
class EmployeeModelResponse {
  ...
  EmployeeModelResponse({this.success, this.error, this.message, this.data});
...
class EmployeeModel {
  ...
  Map<String?, dynamic> toJson() => {
    ...
    "key_skill": keySkill,
    "skill": userSkill,
    "assign_course": List<dynamic>.from(assignCourse!.map((x) => x.toJson())),
  };
}
